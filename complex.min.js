...
a&&"re"in a?(c.re=a.re,c.im=a.im):"abs"in a&&"arg"in a?(c.re=a.abs*Math.cos(a.arg),c.im=a.abs*Math.sin(a.arg)):"r"in a&&"phi"in a?(c.re=a.r*Math.cos(a.phi),c.im=a.r*Math.sin(a.phi)):2===a.length?(c.re=a[0],c.im=a[1]):h();break;case "string":c.im=c.re=0;var f=a.match(/\d+\.?\d*e[+-]?\d+|\d+\.?\d*|\.\d+|./g),l=1,e=0;null===f&&h();for(var g=0;g<f.length;g++){var k=f[g];" "!==k&&"\t"!==k&&"\n"!==k&&("+"===k?l++:"-"===k?e++:("i"===k||"I"===k?(0===l+e&&h()," "===f[g+1]||isNaN(f[g+1])?c.im+=parseFloat((e%
2?"-":"")+"1"):(c.im+=parseFloat((e%2?"-":"")+f[g+1]),g++)):((0===l+e||isNaN(k))&&h(),"i"===f[g+1]||"I"===f[g+1]?(c.im+=parseFloat((e%2?"-":"")+k),g++):c.re+=parseFloat((e%2?"-":"")+k)),l=e=0))}0<l+e&&h();break;case "number":c.im=0;c.re=a;break;default:h()}this.re=c.re;this.im=c.im}d.prototype={re:0,im:0,sign:function(){var a=this.abs();return new d(this.re/a,this.im/a)},add:function(a,b){var c=new d(a,b);return this.a()&&c.a()?d.NAN:this.a()||c.a()?d.INFINITY:new d(this.re+c.re,this.im+c.im)},sub:function(a,
b){var c=new d(a,b);return this.a()&&c.a()?d.NAN:this.a()||c.a()?d.INFINITY:new d(this.re-c.re,this.im-c.im)},mul:function(a,b){var c=new d(a,b);return this.a()&&c.b()||this.b()&&c.a()?d.NAN:this.a()||c.a()?d.INFINITY:0===c.im&&0===this.im?new d(this.re*c.re,0):new d(this.re*c.re-this.im*c.im,this.re*c.im+this.im*c.re)},div:function(a,b){var c=new d(a,b);if(this.b()&&c.b()||this.a()&&c.a())return d.NAN;if(this.a()||c.b())return d.INFINITY;if(this.b()||c.a())return d.ZERO;a=this.re;b=this.im;var f=
c.re,e=c.im;if(0===e)return new d(a/f,b/f);if(Math.abs(f)<Math.abs(e))return c=f/e,f=f*c+e,new d((a*c+b)/f,(b*c-a)/f);c=e/f;f=e*c+f;return new d((a+b*c)/f,(b-a*c)/f)},pow:function(a,b){var c=new d(a,b);a=this.re;b=this.im;if(c.b())return d.ONE;if(0===c.im){if(0===b&&0<=a)return new d(Math.pow(a,c.re),0);if(0===a)switch((c.re%4+4)%4){case 0:return new d(Math.pow(b,c.re),0);case 1:return new d(0,Math.pow(b,c.re));case 2:return new d(-Math.pow(b,c.re),0);case 3:return new d(0,-Math.pow(b,c.re))}}var f=
Math.atan2(b,a),e=m(a,b);a=Math.exp(c.re*e-c.im*f);b=c.im*e+c.re*f;return new d(a*Math.cos(b),a*Math.sin(b))},sqrt:function(){var a=this.re,b=this.im,c=this.abs();if(0<=a){if(0===b)return new d(Math.sqrt(a),0);var f=.5*Math.sqrt(2*(c+a))}else f=Math.abs(b)/Math.sqrt(2*(c-a));a=0>=a?.5*Math.sqrt(2*(c-a)):Math.abs(b)/Math.sqrt(2*(c+a));return new d(f,0>b?-a:a)},exp:function(){var a=Math.exp(this.re);return new d(a*Math.cos(this.im),a*Math.sin(this.im))},log:function(){var a=this.re,b=this.im;return new d(m(a,
b),Math.atan2(b,a))},abs:function(){var a=this.re;var b=this.im,c=Math.abs(a),d=Math.abs(b);3E3>c&&3E3>d?a=Math.sqrt(c*c+d*d):(c<d?(c=d,d=a/b):d=b/a,a=c*Math.sqrt(1+d*d));return a},arg:function(){return Math.atan2(this.im,this.re)},sin:function(){var a=this.re,b=this.im;return new d(Math.sin(a)*e(b),Math.cos(a)*g(b))},cos:function(){var a=this.re,b=this.im;return new d(Math.cos(a)*e(b),-Math.sin(a)*g(b))},tan:function(){var a=2*this.re,b=2*this.im,c=Math.cos(a)+e(b);return new d(Math.sin(a)/c,g(b)/
c)},cot:function(){var a=2*this.re,b=2*this.im,c=Math.cos(a)-e(b);return new d(-Math.sin(a)/c,g(b)/c)},sec:function(){var a=this.re,b=this.im,c=.5*e(2*b)+.5*Math.cos(2*a);return new d(Math.cos(a)*e(b)/c,Math.sin(a)*g(b)/c)},csc:function(){var a=this.re,b=this.im,c=.5*e(2*b)-.5*Math.cos(2*a);return new d(Math.sin(a)*e(b)/c,-Math.cos(a)*g(b)/c)},asin:function(){var a=this.re,b=this.im,c=(new d(b*b-a*a+1,-2*a*b)).sqrt();a=(new d(c.re-b,c.im+a)).log();return new d(a.im,-a.re)},acos:function(){var a=this.re,
b=this.im,c=(new d(b*b-a*a+1,-2*a*b)).sqrt();a=(new d(c.re-b,c.im+a)).log();return new d(Math.PI/2-a.im,a.re)},atan:function(){var a=this.re,b=this.im;if(0===a){if(1===b)return new d(0,Infinity);if(-1===b)return new d(0,-Infinity)}var c=a*a+(1-b)*(1-b);a=(new d((1-b*b-a*a)/c,-2*a/c)).log();return new d(-.5*a.im,.5*a.re)},acot:function(){var a=this.re,b=this.im;if(0===b)return new d(Math.atan2(1,a),0);var c=a*a+b*b;return 0!==c?(new d(a/c,-b/c)).atan():(new d(0!==a?a/0:0,0!==b?-b/0:0)).atan()},asec:function(){var a=
