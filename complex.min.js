/*
Complex.js v1.4.0 22/06/2015

Copyright (c) 2015, Robert Eisele (robert@xarg.org)
Dual licensed under the MIT or GPL Version 2 licenses.
*/
(function(m){"use strict";function g(a,b){if(null===a||void 0===a)c.r=0,c.i=0;else if(void 0!==b)c.r=a,c.i=b;else switch(typeof a){case "object":"i"in a&&"r"in a?(c.r=a.r,c.i=a.i):"abs"in a&&"arg"in a?(c.r=a.abs*Math.cos(a.arg),c.i=a.abs*Math.sin(a.arg)):l();break;case "string":c.i=c.r=0;for(var f=/[+-]?[\di.]+/g,e,g=0;null!==(e=f.exec(a));g=1)if(-1!==e[0].indexOf("i")){e=e[0].replace("i","");if("+"===e||"-"===e||""===e)e+="1";c.i+=parseFloat(e)}else c.r+=parseFloat(e[0]);0===g&&l();break;case "number":c.i=0;
c.r=a;break;default:l()}isNaN(c.r*c.i)&&l()}function l(){throw"Invalid Param";}function h(a){return(Math.exp(a)-Math.exp(-a))/2}function k(a){return(Math.exp(a)+Math.exp(-a))/2}function b(a,d){if(!(this instanceof b))return new b(a,d);g(a,d);this.r=c.r;this.i=c.i}var c={b:0,a:0};b.prototype.r=0;b.prototype.i=0;b.prototype.add=function(a,d){g(a,d);return new b(this.r+c.r,this.i+c.i)};b.prototype.sub=function(a,d){g(a,d);return new b(this.r-c.r,this.i-c.i)};b.prototype.mul=function(a,d){g(a,d);return new b(this.r*
c.r-this.i*c.i,this.r*c.i+this.i*c.r)};b.prototype.div=function(a,d){g(a,d);a=c.r;d=c.i;var f=a*a+d*d;if(0===f)throw"DIV/0";return new b((a*this.r+d*this.i)/f,(a*this.i-d*this.r)/f)};b.prototype.pow=function(a,d){g(a,d);a=this.r;d=this.i;var f=a*a+d*d,e=Math.atan2(d,a);if(0===f)return new b(0);var h=Math.pow(f,c.r/2)*Math.exp(-c.i*e),f=c.i*Math.log(f)/2+c.r*e;return new b(h*Math.cos(f),h*Math.sin(f))};b.prototype.sqrt=function(){var a=this.abs();return new b(Math.sqrt((a+this.r)/2),Math.sqrt((a-this.r)/
...
b.prototype.equals=function(a,b){g(a,b);return 1E-16>=c.r-this.r&&1E-16>=c.i-this.i};b.prototype.clone=function(){return new b(this.r,this.i)};b.prototype.toString=function(){var a=this.r,b=this.i;if(isNaN(a*b))return"NaN";var c="";0!==a&&(c+=a);0!==b&&(0<b&&0!==a&&(c+="+"),1!==b&&(c=-1===b?c+"-":c+b),c+="i");return""===c?"0":c};b.prototype.toVector=function(){return[this.b,this.a]};b.prototype.valueOf=function(){return 0===this.i?this.r:null};b.ZERO=new b(0,0);b.ONE=new b(1,0);b.I=new b(0,1);b.PI=
new b(Math.PI,0);b.E=new b(Math.E,0);"function"===typeof define&&define.amd?define([],function(){return b}):"object"===typeof exports?module.exports=b:m.Complex=b})(this);
