/*
Complex.js v2.2.5 10/10/2024
https://raw.org/article/complex-numbers-in-javascript/

Copyright (c) 2024, Robert Eisele (https://raw.org/)
Licensed under the MIT license.
*/
'use strict';(function(n){function l(){throw SyntaxError("Invalid Param");}function m(a,b){var c=Math.abs(a),e=Math.abs(b);if(0===a)return Math.log(e);if(0===b)return Math.log(c);if(3E3>c&&3E3>e)return.5*Math.log(a*a+b*b);a/=2;b/=2;return.5*Math.log(a*a+b*b)+Math.LN2}function d(a,b){if(!(this instanceof d))return new d(a,b);var c=a;a={re:0,im:0};if(void 0===c||null===c)a.re=a.im=0;else if(void 0!==b)a.re=c,a.im=b;else switch(typeof c){case "object":"im"in c&&"re"in c?(a.re=c.re,a.im=c.im):"abs"in
c&&"arg"in c?!Number.isFinite(c.abs)&&Number.isFinite(c.arg)?a=d.INFINITY:(a.re=c.abs*Math.cos(c.arg),a.im=c.abs*Math.sin(c.arg)):"r"in c&&"phi"in c?!Number.isFinite(c.r)&&Number.isFinite(c.phi)?a=d.INFINITY:(a.re=c.r*Math.cos(c.phi),a.im=c.r*Math.sin(c.phi)):2===c.length?(a.re=c[0],a.im=c[1]):l();break;case "string":a.im=a.re=0;c=c.replace(/_/g,"");b=c.match(/\d+\.?\d*e[+-]?\d+|\d+\.?\d*|\.\d+|./g);c=1;var e=0;null===b&&l();for(var f=0;f<b.length;f++){var h=b[f];" "!==h&&"\t"!==h&&"\n"!==h&&("+"===
h?c++:"-"===h?e++:("i"===h||"I"===h?(0===c+e&&l()," "===b[f+1]||isNaN(b[f+1])?a.im+=parseFloat((e%2?"-":"")+"1"):(a.im+=parseFloat((e%2?"-":"")+b[f+1]),f++)):((0===c+e||isNaN(h))&&l(),"i"===b[f+1]||"I"===b[f+1]?(a.im+=parseFloat((e%2?"-":"")+h),f++):a.re+=parseFloat((e%2?"-":"")+h)),c=e=0))}0<c+e&&l();break;case "number":a.im=0;a.re=c;break;default:l()}this.re=a.re;this.im=a.im}var g=Math.cosh||function(a){return 1E-9>Math.abs(a)?1-a:.5*(Math.exp(a)+Math.exp(-a))},k=Math.sinh||function(a){return 1E-9>
Math.abs(a)?a:.5*(Math.exp(a)-Math.exp(-a))};d.prototype={re:0,im:0,sign:function(){var a=this.abs();return new d(this.re/a,this.im/a)},add:function(a,b){a=new d(a,b);return this.isInfinite()&&a.isInfinite()?d.NAN:this.isInfinite()||a.isInfinite()?d.INFINITY:new d(this.re+a.re,this.im+a.im)},sub:function(a,b){a=new d(a,b);return this.isInfinite()&&a.isInfinite()?d.NAN:this.isInfinite()||a.isInfinite()?d.INFINITY:new d(this.re-a.re,this.im-a.im)},mul:function(a,b){a=new d(a,b);return this.isInfinite()&&
a.isZero()||this.isZero()&&a.isInfinite()?d.NAN:this.isInfinite()||a.isInfinite()?d.INFINITY:0===a.im&&0===this.im?new d(this.re*a.re,0):new d(this.re*a.re-this.im*a.im,this.re*a.im+this.im*a.re)},div:function(a,b){var c=new d(a,b);if(this.isZero()&&c.isZero()||this.isInfinite()&&c.isInfinite())return d.NAN;if(this.isInfinite()||c.isZero())return d.INFINITY;if(this.isZero()||c.isInfinite())return d.ZERO;a=this.re;b=this.im;var e=c.re,f=c.im;if(0===f)return new d(a/e,b/e);if(Math.abs(e)<Math.abs(f))return c=
e/f,e=e*c+f,new d((a*c+b)/e,(b*c-a)/e);c=f/e;e=f*c+e;return new d((a+b*c)/e,(b-a*c)/e)},pow:function(a,b){var c=new d(a,b);a=this.re;b=this.im;if(c.isZero())return d.ONE;if(0===c.im){if(0===b&&0<a)return new d(Math.pow(a,c.re),0);if(0===a)switch((c.re%4+4)%4){case 0:return new d(Math.pow(b,c.re),0);case 1:return new d(0,Math.pow(b,c.re));case 2:return new d(-Math.pow(b,c.re),0);case 3:return new d(0,-Math.pow(b,c.re))}}if(0===a&&0===b&&0<c.re&&0<=c.im)return d.ZERO;var e=Math.atan2(b,a);b=m(a,b);
a=Math.exp(c.re*b-c.im*e);b=c.im*b+c.re*e;return new d(a*Math.cos(b),a*Math.sin(b))},sqrt:function(){var a=this.re,b=this.im,c=this.abs();if(0<=a){if(0===b)return new d(Math.sqrt(a),0);var e=.5*Math.sqrt(2*(c+a))}else e=Math.abs(b)/Math.sqrt(2*(c-a));a=0>=a?.5*Math.sqrt(2*(c-a)):Math.abs(b)/Math.sqrt(2*(c+a));return new d(e,0>b?-a:a)},exp:function(){var a=Math.exp(this.re);return new d(a*Math.cos(this.im),a*Math.sin(this.im))},expm1:function(){var a=this.re,b=this.im,c=Math.expm1(a)*Math.cos(b);var e=
